...
public class PullRequestIssuePostJobTest {
  ...
  public void testPullRequestAnalysisWithNewIssues() {
    ...
    verify(pullRequestFacade)
      .createOrUpdateGlobalComments(contains("* ![BLOCKER](https://sonarsource.github.io/sonar-github/severity-blocker.png) 5 blocker"));
    verify(pullRequestFacade)
    ...
    verify(pullRequestFacade)
      .createOrUpdateGlobalComments(
        contains(
          "1. ![BLOCKER](https://sonarsource.github.io/sonar-github/severity-blocker.png) [Foo.php#L2](http://github/blob/abc123/src/Foo.php#L2): msg2 [![rule](https://sonarsource.github.io/sonar-github/rule.png)](http://myserver/coding_rules#rule_key=repo%3Arule)"));
